...
public partial class alglib
{
    /*************************************************************************
     *   
     *  These are implementations that resemble MATLAB (use fft1 instead of fft)
     *  
     *  fftshift(ifftshift) is capable of specifying the direction in 2D (-1 
     *  means both sides, 0 means in row direction , 1 means in col direction).s
     * 
     *************************************************************************/
    ...
    public static complex[] ifft1(complex[] a)
    {
        int n = ap.len(a);
        complex[] b = copy(a);
    ...
    static void rotleft(complex[] a, int d, int n)
    {
        int i, j, k;
        complex tmp;
        d = d % n;
    ...
    static void rotleft(double[] a, int d, int n)
    {
        int i, j, k;
        double tmp;
        d = d % n;
...
public partial class alglib
{
    /*************************************************************************
               ...
               2D FFTs (only for complex input)

     *************************************************************************/
    public static void fftc2d(complex[,] a, int m, int n, alglib.xparams _params)
    {
        fft.fftc2d(a, m, n, _params);
    }

    public static void fftc2d(complex[,] a, int m, int n)
    {
        fft.fftc2d(a, m, n, null);
    }

    public static void fftc2d(complex[,] a)
    {
        int m = ap.rows(a);
        int n = ap.cols(a);
        fft.fftc2d(a, m, n, null);
    ...
    public static void fftc2dinv(complex[,] a, int m, int n, alglib.xparams _params)
    {
        fft.fftc2dinv(a, m, n, _params);
    }

    public static void fftc2dinv(complex[,] a, int m, int n)
    {
        fft.fftc2dinv(a, m, n, null);
    }

    public static void fftc2dinv(complex[,] a)
    {
        int m = ap.rows(a);
        int n = ap.cols(a);
        fft.fftc2dinv(a, m, n, null);
...
public partial class alglib
{
    public class fft
    {
        /*************************************************************************
            ...
            >>>>>>>> Self-implemented 2-dimensional complex FFT. <<<<<<<<<<<<
        ...
        *************************************************************************/
        ...
        {
            complex[] frow = new complex[n];
            complex[] fcol = new complex[m];
